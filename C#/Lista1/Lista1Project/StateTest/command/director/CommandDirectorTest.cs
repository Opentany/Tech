...
//    [TestMethod]
//    public void testCommandDirectorSimple() {//} ErrorDirectingCommandsException, ApplianceCommunicationException {
//        CommandDirector director = createCommandDirector();
//        // create some mocked appliances

//        Event eventt = createEvent();
//        // Create commands
//        Command otherCommand = new TurnOnApplianceCommand(radio);

//        director.addCommand(eventt, otherCommand);
...
//    [TestMethod]
//    public void testCommandFailing() {//} ApplianceCommunicationException {
//        CommandDirector director = createCommandDirector();
//        // create some mocked appliances
